...
/************************************************************************
 * CountingLhExternWidget.kt is the interface for widget_counting_lhe.xml
 *
 ...
 */
class CountingLhExternWidget(context: Context, attrs: AttributeSet?) : RelativeLayout(context, attrs) {
    var sHeight: Int = 0
    var ht: Int = 0
