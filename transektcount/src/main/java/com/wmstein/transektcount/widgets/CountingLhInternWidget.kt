...
/*********************************************************************
 * CountingLhInternWidget is the interface for widget_counting_lhi.xml
 *
 ...
 */
class CountingLhInternWidget(context: Context, attrs: AttributeSet?) : RelativeLayout(context, attrs) {
    var sHeight: Int = 0
    var ht: Int = 0
