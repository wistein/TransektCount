...
/********************************************************************
 * CountingInternWidget.kt is the interface for widget_counting_i.xml
 *
 ...
 */
class CountingInternWidget(context: Context, attrs: AttributeSet?) : RelativeLayout(context, attrs) {
    var sHeight: Int = 0
    var ht: Int = 0
