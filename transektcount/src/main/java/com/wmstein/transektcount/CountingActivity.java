...
import com.wmstein.transektcount.widgets.CountingExternWidget;
import com.wmstein.transektcount.widgets.CountingHead1Widget;
import com.wmstein.transektcount.widgets.CountingHead2Widget;
import com.wmstein.transektcount.widgets.CountingHead3Widget;
import com.wmstein.transektcount.widgets.CountingInternWidget;
import com.wmstein.transektcount.widgets.CountingLhExternWidget;
import com.wmstein.transektcount.widgets.CountingLhInternWidget;
...
public class CountingActivity
    ...
    // CountingWidgets
    private List<CountingInternWidget> countingWidget_i;
    private List<CountingExternWidget> countingWidget_e;
    private List<CountingLhInternWidget> countingWidgetLH_i;
    private List<CountingLhExternWidget> countingWidgetLH_e;
    ...
    private void countingScreen(Count count) {
        ...
        CountingHead2Widget head2 = new CountingHead2Widget(this, null);
        ...
        if (lhandPref) // if left-handed counting page
        {
            CountingLhInternWidget widgeti = new CountingLhInternWidget(this, null);
            widgeti.setCountLHi(count);
            countingWidgetLH_i.add(widgeti);
            countsFieldArea1.addView(widgeti);
        } else {
            CountingInternWidget widgeti = new CountingInternWidget(this, null);
        ...
        CountingHead3Widget head3 = new CountingHead3Widget(this, null);
        head3.setCountHead3();
        ...
        if (lhandPref) // if left-handed counting page
        {
            CountingLhExternWidget widgete = new CountingLhExternWidget(this, null);
            widgete.setCountLHe(count);
            countingWidgetLH_e.add(widgete);
            countsFieldArea2.addView(widgete);
        } else {
            CountingExternWidget widgete = new CountingExternWidget(this, null);
    ...
    private CountingInternWidget getCountFromId_i(int id) {
        for (CountingInternWidget widget : countingWidget_i) {
    ...
    private CountingLhInternWidget getCountFromIdLH_i(int id) {
        for (CountingLhInternWidget widget : countingWidgetLH_i) {
            assert widget.count != null;
            if (widget.count.id == id)
                return widget;
        }
    ...
    private CountingExternWidget getCountFromId_e(int id) {
        for (CountingExternWidget widget : countingWidget_e) {
            assert widget.count != null;
            if (widget.count.id == id)
                return widget;
        }
    ...
    private CountingLhExternWidget getCountFromIdLH_e(int id) {
        for (CountingLhExternWidget widget : countingWidgetLH_e) {
            assert widget.count != null;
            if (widget.count.id == id)
                return widget;
        }
    ...
    public void countUpf1i(View view) {
        ...
        if (widget != null) {
            ...
            if (newCounter > oldCounter) // has actually counted up
            {
                ...
                assert widget.count != null;
                if (buttonSoundPref)
                    soundService.soundPlusButtonSound();
    ...
    public void countUpLHf1i(View view) {
        ...
        CountingLhInternWidget widget = getCountFromIdLH_i(tempCountId);
        if (widget != null) {
            oldCounter = count.count_f1i;
            widget.countUpLHf1i();
            assert widget.count != null;
    ...
    public void countUpLHf1e(View view) {
        ...
        CountingLhExternWidget widget = getCountFromIdLH_e(tempCountId);
        if (widget != null) {
            oldCounter = count.count_f1e;
            widget.countUpLHf1e();
            assert widget.count != null;
